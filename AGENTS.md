...
Yang Dipercuan — a Next.js 16 (App Router, React 19) web app for tracking Indonesian (IDX / `.JK`) stocks and managing a personal portfolio (purchases, sales, dividends, watchlist). Monorepo-style layout (`backend/`, `frontend/`, `docs/`); this `AGENTS.md` covers `frontend/`, currently the only active code.
